...
CREATE TABLE Diagnosticos (
    id INT PRIMARY KEY, -- ID del diagnóstico
    id_paciente INT NOT NULL, -- ID del paciente (clave foránea)
    id_doctor INT NOT NULL, -- ID del doctor (clave foránea)
...
(1, 'Juan', 'Pérez', '1980-05-15', 'Av. Siempre Viva 123', '555-1234', 'juan.perez@example.com', 'Masculino'),
(2, 'María', 'González', '1992-10-30', 'Calle Falsa 456', '555-5678', 'maria.gonzalez@example.com', 'Femenino');

-- Insertar datos en Doctores
INSERT INTO Doctores (id, nombre, apellido, especialidad, telefono, email) VALUES
(1, 'Ana', 'López', 'Cardiología', '555-8765', 'ana.lopez@example.com'),
(2, 'Carlos', 'Martínez', 'Pediatría', '555-4321', 'carlos.martinez@example.com');
...
(2, 2, 2, '2024-09-06 10:30:00', 'Consulta pediátrica');
...
(1, 1, 1, 'Tratamiento para hipertensión', '2024-01-10', '2024-04-10'),
...
(1, 1, 1, '2024-03-01', 'Diagnóstico de hipertensión leve'),
(2, 2, 2, '2024-02-20', 'Diagnóstico de alergia estacional');
